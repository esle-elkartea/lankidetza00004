 ...
 *
 */
public abstract class BaseMarcaController extends AppController
{
 private static final Logger logger = Logger.getLogger("net.idtoki.serteca.controller.BaseMarcaController");
 ...
 protected StringBuffer updateIdResponseCallBack(String s)
 {
  ArrayList a = AjaxUtils.splitIdFields(s);
    	return new StringBuffer(Integer.toString(MarcaManager.getMarca(  Integer.parseInt(a.get(0).toString())).getId()));
   }
 ...
 {
  ArrayList a = AjaxUtils.splitIdFields(s);
    	return new StringBuffer(MarcaManager.getMarca(  Integer.parseInt(a.get(0).toString())).getNombre());
   }
 ...
 public void serviceDeleteMarca(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
 {
  ...
  {
   ArrayList a = AjaxUtils.splitIdFields(WebUtils.getStringParam(request, UPDATE_PRIMARY_KEY_FORM_NAME));
   MarcaManager.deleteMarca(  Integer.parseInt(a.get(0).toString()));
  }
  catch (Exception e)
  {
 ...
 public void serviceAddUpdateMarca(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
 {
  utf8RequestService(request);
  try
  {
   MarcaManager.addUpdateMarca(MarcaHelper.createObj(request));
  }
   catch(Exception e)
  {
   response.sendError(HttpServletResponse.SC_INTERNAL_SERVER_ERROR);
