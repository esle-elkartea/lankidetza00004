 ...
 *
 */
public abstract class BaseTrabajadorGroupBean
    extends BaseGroupBean
{

    /** el logger para esta clase */
    private static final Logger logger = Logger
			.getLogger("net.idtoki.serteca.BaseTrabajadorGroup");
	...
	public void setTrabajadors(Criteria criteria, boolean paginado) {
		this.setElementos(criteria, paginado);
	}

	public Trabajador getTrabajador() {
		return (Trabajador) getNext();
	}

	public Trabajador getTrabajador(int posicion) {
		return (Trabajador) get(posicion);
	}
