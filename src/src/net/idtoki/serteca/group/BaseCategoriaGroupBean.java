 ...
 *
 */
public abstract class BaseCategoriaGroupBean
    extends BaseGroupBean
{

    /** el logger para esta clase */
    private static final Logger logger = Logger
			.getLogger("net.idtoki.serteca.BaseCategoriaGroup");
	...
	public void setCategorias(Criteria criteria, boolean paginado) {
		this.setElementos(criteria, paginado);
	}

	public Categoria getCategoria() {
		return (Categoria) getNext();
	}

	public Categoria getCategoria(int posicion) {
		return (Categoria) get(posicion);
	}
