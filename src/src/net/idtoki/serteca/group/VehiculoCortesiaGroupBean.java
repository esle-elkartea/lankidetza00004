 ...
 */
public class VehiculoCortesiaGroupBean
    extends net.idtoki.serteca.group.BaseVehiculoCortesiaGroupBean
{
  public VehiculoCortesiaGroupBean(){
        this.dbField = VehiculoCortesiaPeer.ID;
