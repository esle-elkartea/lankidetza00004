 ...
 */
public class LineaFacturaGroupBean
    extends net.idtoki.serteca.group.BaseLineaFacturaGroupBean
{
  public LineaFacturaGroupBean(){
        this.dbField = LineaFacturaPeer.ID;
