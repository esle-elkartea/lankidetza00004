 ...
 *
 */
public abstract class BaseFacturasGroupBean
    extends BaseGroupBean
{

    /** el logger para esta clase */
    private static final Logger logger = Logger
			.getLogger("net.idtoki.serteca.BaseFacturasGroup");
	...
	public void setFacturass(Criteria criteria, boolean paginado) {
		this.setElementos(criteria, paginado);
	}

	public Facturas getFacturas() {
		return (Facturas) getNext();
	}

	public Facturas getFacturas(int posicion) {
