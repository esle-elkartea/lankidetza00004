 ...
 *
 */
public abstract class BaseLocalidadGroupBean
    extends BaseGroupBean
{

    /** el logger para esta clase */
    private static final Logger logger = Logger
			.getLogger("net.idtoki.serteca.BaseLocalidadGroup");
	...
	public void setLocalidads(Criteria criteria, boolean paginado) {
		this.setElementos(criteria, paginado);
	}

	public Localidad getLocalidad() {
		return (Localidad) getNext();
	}

	public Localidad getLocalidad(int posicion) {
		return (Localidad) get(posicion);
	}
	...
	public List abstractVillageRecords(Criteria c) throws TorqueException {
		return LocalidadPeer.doSelectVillageRecords(c);
	}

	public void abstractSave(Connection conn) throws TorqueException {
		Localidad element = null;
		while (this.next()) {
			element = this.getLocalidad();
			element.save(conn);
		}
	}
