 ...
 *
 */
public abstract class BaseClienteGroupBean
    extends BaseGroupBean
{

    /** el logger para esta clase */
    private static final Logger logger = Logger
			.getLogger("net.idtoki.serteca.BaseClienteGroup");
	...
	public void setClientes(Criteria criteria, boolean paginado) {
		this.setElementos(criteria, paginado);
	}

	public Cliente getCliente() {
		return (Cliente) getNext();
	}
