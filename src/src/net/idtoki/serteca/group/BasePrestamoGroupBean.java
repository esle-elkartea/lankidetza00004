 ...
 *
 */
public abstract class BasePrestamoGroupBean
    extends BaseGroupBean
{

    /** el logger para esta clase */
    private static final Logger logger = Logger
			.getLogger("net.idtoki.serteca.BasePrestamoGroup");
	...
	public void setPrestamos(Criteria criteria, boolean paginado) {
		this.setElementos(criteria, paginado);
	}

	public Prestamo getPrestamo() {
		return (Prestamo) getNext();
	}

	public Prestamo getPrestamo(int posicion) {
		return (Prestamo) get(posicion);
	}
