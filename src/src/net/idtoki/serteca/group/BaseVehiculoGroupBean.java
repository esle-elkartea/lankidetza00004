 ...
 *
 */
public abstract class BaseVehiculoGroupBean
    extends BaseGroupBean
{

    /** el logger para esta clase */
    private static final Logger logger = Logger
			.getLogger("net.idtoki.serteca.BaseVehiculoGroup");
	...
	public void setVehiculos(Criteria criteria, boolean paginado) {
		this.setElementos(criteria, paginado);
	}

	public Vehiculo getVehiculo() {
		return (Vehiculo) getNext();
	}
